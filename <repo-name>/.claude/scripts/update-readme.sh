...
check_file "Library/LaunchAgents/com.claude.memory-log.plist"
check_file "Library/LaunchAgents/com.claude.memory-distill.plist"
check_file "Library/LaunchAgents/com.claude.memory-promote.plist"
check_file "Library/LaunchAgents/com.claude.memory-sync.plist"
check_file "<repo-name>/.claude/hooks/pre-push"
