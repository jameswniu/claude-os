...
Source: https://basis.atlassian.net/wiki/spaces/BET/pages/242352261
...
## Development (10/25-10/26)
  ...
  * Refer to the following resources to aid you in the development process: <https://basis.atlassian.net/wiki/spaces/~kiu.lam/pages/277053763/Resources+on+Hackathon>
  ...
  * Repositories
    ...
    * Repositories have been created in Bitbucket for each team under the [HACK project](https://stash.centro.net/projects/HACK)

    * Please find your team's repository [here](https://stash.centro.net/projects/HACK) based on your team number
    ...
    * A kubernetes cluster (eks-hackathon) is deployed to enable teams to deploy their application
      ...
      * Setup your shell:
        ...
        * 1. If you have never used kubectl on your workstation before run this step:
          ...
          * <https://basis.atlassian.net/wiki/spaces/CYAN/pages/40501410/EKS+Onboarding+Guide#%5BinlineExtension%5DStep-2%3A-Configure-SSO>
  ...
  * Adhere to the [Security policies](https://basis.atlassian.net/wiki/spaces/BET/pages/242352261/Basis+Hack-AI-thon+October+2023#Security-Considerations-and-Guidelines) detailed below
...
<https://basis.atlassian.net/wiki/spaces/~kiu.lam/pages/277053763/Resources+on+Hackathon>
