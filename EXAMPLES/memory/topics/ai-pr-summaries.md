...
Source: https://basis.atlassian.net/wiki/spaces/BET/pages/1425604970

# [PR Descriptions POC](https://stash.centro.net/projects/CEN/repos/ai-council/pull-requests/1/diff#pr-descriptions%2Fgenerate_pr_description.py)
...
This feature exists in Bitbucket Cloud. We use Bitbucket Server (Data Center) and likely **cannot use this feature** unless we migrate to Bitbucket Cloud. We need to contact the Atlassian Team (Frieda) to see if any AI features can be enabled in our Bitbucket. <https://basis.atlassian.net/servicedesk/customer/portal/5/AS-98>
